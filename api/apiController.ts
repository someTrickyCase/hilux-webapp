export const fetchHomePageData = async () => {
    try {
        const resJSON = await fetch("http://localhost:8000/get-categories", {
            method: "get",
            headers: {
...
export const fetchCategoryPageData = async (categoryLink: string, page: number) => {
    try {
        const resJSON = await fetch("http://localhost:8000/product-category", {
            method: "get",
            headers: {
                "Constent-Type": "application/json",
...
export const sendOrderData = async (sendedData: any) => {
    try {
        const resJSON = await fetch("http://localhost:8000/order", {
            method: "post",
            headers: {
                "Constent-Type": "application/json",
            },
